"""
CO3Net — Cross-Domain Closed-Set Evaluations on X-Palm
=========================================================
...
def run_experiment(train_samples, gallery_samples, probe_samples,
    ...
    """
    Train CO3Net and evaluate using the last-epoch checkpoint.
...
def print_and_save_summary(all_results, out_path):
    ...
    header = (f"{'Setting':<22}"
              ...
              f"{'Rank-1 (%)':>{col_w}}")
    sep = "─" * len(header)
    lines = ["\nCross-Domain Closed-Set Results — X-Palm (CO3Net)", sep, header, sep]
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"  CO3Net — Cross-Domain Closed-Set (X-Palm)")
